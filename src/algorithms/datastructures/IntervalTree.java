...
/**
 * Represents a simple Interval MySolutions.Tree. Please note that this interval tree does not balance itself because it is not based e.g. on a Red-Black tree.
 * 
...
public class IntervalTree {
    ...
    public static void main(String... args) {
        ...
        System.out.println("Inorder traversal of constructed Interval MySolutions.Tree is");
        tree.inorder();
