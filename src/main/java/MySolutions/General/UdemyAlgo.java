...
public class UdemyAlgo{
    ...
    public static int Tribonacci(int n){
        ...
        return Tribonacci(n - 1) - Math.max();
    }*/
    ...
    //Naive
    public static int MazeRatN(int i, int j, int m, int n, int[][]Maze){
        ...
        return MazeRatN(i + 1, j, m, n, Maze) +
                MazeRatN(i, j + 1, m, n, Maze);
    }
    ...
    //Naive
    public static void ArrangeN(int i, int n, int[] Array, int[] Basket){
        if(i == n){
            int temp[] = new int[n];
            for(int l = 0; l < n; l++)
                temp[i] = Array[i];
        ...
        for(int l = 0; l < n; l++){
            Array[i] = Basket[l];
            ArrangeN(i + 1, n, Array, Basket);
        }

    }

    //Optimized
    public static void ArrangeOpt(int i, int n, int[]Array, int[]Basket){
        if(i == n){
            for(int l = 0; l < n; l++)
        ...
        for(int l = 0; l < n; l++){
            ...
            Array[i] = Basket[l];
            Basket[l] = -1;
            ArrangeOpt(i + 1, n, Array, Basket);
            Basket[l] = Array[i];
        }
    }

    //More optimized
    static void swapArr(int i, int j, int[] arr){
        int temp = arr[i];
        arr[i] = arr[j];
        arr[j] = temp;
    }

    public static void ArrangeOptMore(int i, int n,  int[]Basket){
        if(i == n){
            for(int l = 0; l < n; l++)
