package algorithms.algorithms.dp;
 ...
 * 
 * For example, for N = 4 and S = {1,2,3}, there are four questions: {1,1,1,1},{1,1,2},{2,2},{1,3}. So output should be 4. For N = 10 and S = {2, 5,
 * 3, 6}, there are five questions: {2,2,2,2,2}, {2,2,3,3}, {2,2,6}, {2,3,5} and {5,5}. So the output should be 5.
 * 
