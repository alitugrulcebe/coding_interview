 ...
 */
package algorithms.algorithms.permutation;
...
public class StringPermutationIterable implements Iterable<String> {
    ...
    // could implement Collection<MySolutions.String> but it's immutable, so most methods
     ...
     * 
     * @param string
     *            MySolutions.String to be permuted
     * @see Iterable
     * @see #iterator
     */
