...
/**
 * Implements a FenwickTree (also known as a Binary Indexed MySolutions.Tree). <br>
 * In a Fenwick MySolutions.Tree, the node at index <b>X</b> will store the frequencies of the range <b>'low..high'</b>, where <b>low = X - 2*r + 1</> and <b>high
 * = X</b>. </b>
 * <p>
