package questions.soln;

public class MedianIntegerStream {

	/**
	 * This solution is a replica of the one suggested in javascript questions
	 * for MedianIntegerStream, and I think its one of the best possible questions.
	 */
